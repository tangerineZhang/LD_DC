...
namespace LDDC.DAL
{
	...
	public partial class zd_OrderState
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "zd_OrderState"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from zd_OrderState");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(LDDC.Model.zd_OrderState model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into zd_OrderState(");
			strSql.Append("id,state,creatorID,creator,createDate,isValid,sortNo)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(LDDC.Model.zd_OrderState model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update zd_OrderState set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from zd_OrderState ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		/// 得到一个对象实体
		/// </summary>
		public LDDC.Model.zd_OrderState GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,state,creatorID,creator,createDate,isValid,sortNo from zd_OrderState ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;

			LDDC.Model.zd_OrderState model=new LDDC.Model.zd_OrderState();
		...
		/// 得到一个对象实体
		/// </summary>
		public LDDC.Model.zd_OrderState DataRowToModel(DataRow row)
		{
			LDDC.Model.zd_OrderState model=new LDDC.Model.zd_OrderState();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,state,creatorID,creator,createDate,isValid,sortNo ");
			strSql.Append(" FROM zd_OrderState ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from zd_OrderState T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "zd_OrderState";
