...
namespace LDDC.DAL
{
    ...
    public partial class zd_VegetableType
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "zd_VegetableType");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from zd_VegetableType");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(LDDC.Model.zd_VegetableType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into zd_VegetableType(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(LDDC.Model.zd_VegetableType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update zd_VegetableType set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from zd_VegetableType ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
            parameters[0].Value = id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public LDDC.Model.zd_VegetableType GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,type,creatorID,creator,createDate,isValid,sortNo from zd_VegetableType ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
            parameters[0].Value = id;

            LDDC.Model.zd_VegetableType model = new LDDC.Model.zd_VegetableType();
        ...
        /// 得到一个对象实体
        /// </summary>
        public LDDC.Model.zd_VegetableType DataRowToModel(DataRow row)
        {
            LDDC.Model.zd_VegetableType model = new LDDC.Model.zd_VegetableType();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM zd_VegetableType ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from zd_VegetableType T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "zd_VegetableType";
